...
const ClickToJoinDialog = ({
  ...
  selectedBrand: Organization | undefined;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => setIsOpen(!isOpen)}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Join brand</DialogTitle>
          {selectedBrand && (
                ...
                <li className="flex items-center justify-between">
                  ...
                  <Link href={selectedBrand?.publicMetadata?.website || "/"}>
                    <span className="text-gray-500 underline">
                      {selectedBrand?.publicMetadata?.website as string}
                    </span>
                  </Link>
                </li>
              </ul>
          ...
          <DialogDescription className="mt-4">
            Once you click join, you&apos;ll be redirected to Kno Global dashboard.
          </DialogDescription>
        </DialogHeader>
